...
parser.add_argument("-L", "--left-team-version", required=True, help="The version of the team on the left")
parser.add_argument("-r", "--right-team-name", required=True, help="The name of the team on the right")
parser.add_argument("-R", "--right-team-version", required=True, help="The version of the team on the right")
